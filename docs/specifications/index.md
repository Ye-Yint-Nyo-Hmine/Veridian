...
- **[`protocol.md`](protocol.md)** — the normative `veridian/1.0` wire protocol: framing,
  lifecycle, host services, `host.contract.call` routing, streaming, error codes, conformance.
